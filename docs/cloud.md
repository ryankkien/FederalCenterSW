...
| Summarizer managed identity | `fcsw-summarizer-dev-mi` | `eastus` | User-assigned identity used by the summarizer Container App for Key Vault references. |
...
Container App secrets. The Function App and summarizer Container App use user-assigned
